...
**Decision (2026-06-15):** Replaced `sys.path` filesystem coupling with explicit PEP 508 git-reference dependencies. See [[platform/Cross-Service-Backlog#8]] for Phase 2 (private registry) backlog.
...
> Full scenario catalogue: [[services/alphaTest/Regression-Scenarios|Regression Scenarios]]
