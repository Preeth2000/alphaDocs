...
| `model_override` | Per-model config overrides | `run_name` (PK), `enabled`, `broker_ticker`, sizing/SL/TP/cooldown overrides, `safe_mode`, `pyramid`, retirement overrides, backtest overrides, `visibility` (private/public), `updated_at` |
...
## Migration History (23 migrations)
